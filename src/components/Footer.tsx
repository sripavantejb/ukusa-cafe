        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/.ukusa." target="_blank" rel="noopener noreferrer" className="bg-[#e5eed8] hover:bg-[#d4d0c0] p-3 rounded-full transition-colors duration-300 group">
